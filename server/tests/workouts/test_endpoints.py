...
def test_post_workout(client, db, user):
    ...
    assert new_workout['date_proposed'] == json_response['date_proposed']
    assert new_workout['exercises'] == json_response['exercises']


def test_get_workout(client, db, user, mixer):
